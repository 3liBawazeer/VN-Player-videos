...
export default function DisplayNotes({show, setshow, seekOn,navigation }) {
          ...
          renderItem={({item,index}) => (
            <TouchableNativeFeedback
              ...
              <View style={{padding: 10, flexDirection: 'row',alignItems:"center"}}>
                ...
                {/* <Icon name='chevron-up' type='entypo' containerStyle={{overflow:"hidden",borderRadius:20}} style={{padding:10}}
                 onPress={()=>{
